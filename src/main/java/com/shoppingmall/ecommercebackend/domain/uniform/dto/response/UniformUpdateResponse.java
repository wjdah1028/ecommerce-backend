...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title = "유니폼 수정 응답 dto", description = "판매자가 유니폼을 수정할때 서버가 반환하는 데이터")
public class UniformUpdateResponse {
    ...
    @Schema(description = "유니폼 수정 시간", example = "2026-07-017T04:00:00")
